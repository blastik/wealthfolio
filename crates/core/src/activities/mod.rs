...
pub use activities_model::{
    ...
    ImportTemplateScope, IncomeData, InternalExchangePairResponse, InternalTransferPairRequest,
    InternalTransferPairResponse, NewActivity, PrepareActivitiesResult,
